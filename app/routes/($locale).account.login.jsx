...
export async function loader({context, params}) {
  ...
  return json({shopName: 'our store'});
}
...
export default function Login() {
  ...
  return (
    <div className="flex justify-center my-24 pt-4 px-4 pointer-events-auto bg-black/60 backgrop-blur-sm">
        ...
        >
          {actionData?.formError && (
            <div className="flex items-center justify-center mb-6 bg-black">
              <p className="m-4 text-xs text-red-500">{actionData.formError}</p>
            </div>
          )}
          <div>
            <input
            ...
            />
            {nativeEmailError && (
              <p className="text-red-500 text-xs bg-black py-2 px-3">
                {nativeEmailError} &nbsp;
              </p>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            <button
              className="bg-contrast text-primary rounded py-2 px-4 focus:shadow-outline block w-full"
              type="submit"
